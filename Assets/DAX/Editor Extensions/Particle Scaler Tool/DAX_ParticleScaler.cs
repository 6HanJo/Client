...
public class DAX_ParticleScaler : EditorWindow 
{
	...
	void OnGUI () 
	{
		try
		{
			...
			#else
			EditorGUILayout.BeginHorizontal();
				ScaleGameObjects = EditorGUILayout.Toggle( "", ScaleGameObjects,GUILayout.MaxWidth(17.0f) );
				EditorGUILayout.LabelField("Scale 'Game Objects' exclude PS" , GUILayout.MaxWidth(310.0f)  );
			EditorGUILayout.EndHorizontal();
			EditorGUILayout.BeginHorizontal();
				ScaleShapeModule = EditorGUILayout.Toggle( "", ScaleShapeModule, GUILayout.MaxWidth(17.0f) );
				EditorGUILayout.LabelField("Scale 'ShapeModule' for PS " , GUILayout.MaxWidth(310.0f)  );
			EditorGUILayout.EndHorizontal();
			#endif
				...
				#else
					EditorGUILayout.BeginHorizontal();
						ScaleObjectHierarchy = EditorGUILayout.Toggle( "", ScaleObjectHierarchy,GUILayout.MaxWidth(17.0f) );
						EditorGUILayout.LabelField("Scale Objects hierarchy" , GUILayout.MaxWidth(310.0f)  );
					EditorGUILayout.EndHorizontal();
					EditorGUILayout.BeginHorizontal();
						MakeClones = EditorGUILayout.Toggle( "", MakeClones, GUILayout.MaxWidth(17.0f) );
						EditorGUILayout.LabelField("Make renamed clones" , GUILayout.MaxWidth(310.0f)  );
					EditorGUILayout.EndHorizontal();
				#endif
